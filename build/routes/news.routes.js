...
router.post("/news/create", multer_config_1.upload.single("image"), news_controller_1.createNews);
router.get("/news", news_controller_1.getNews);
router.get("/news/:id", news_controller_1.getNewsById);
router.put("/news/update/:id", multer_config_1.upload.single("image"), news_controller_1.updateNews);
