...
export const createCarouselImage: RequestHandler = async (req: Request, res: Response) => {
...
export const getCarouselImages: RequestHandler = async (req: Request, res: Response) => {
    const carouselService = new CarouselService();
    try {
...
export const updateCarouselImage: RequestHandler = async (req: Request, res: Response) => {
    const { id } = req.params;
    const carouselService = new CarouselService();
    try {
...
export const deleteCarouselImage: RequestHandler = async (req: Request, res: Response) => {
    const { id } = req.params;
    const carouselService = new CarouselService();
    try {
