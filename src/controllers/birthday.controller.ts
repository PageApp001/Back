...
export const createBirthdaylImage: RequestHandler = async (req: Request, res: Response) => {
...
export const getBirthdayImages: RequestHandler = async (req: Request, res: Response) => {
    const birthdayService = new BirthdayService();
    try {
...
export const deleteBirthdayImage: RequestHandler = async (req: Request, res: Response) => {
    const { id } = req.params;
    const birthdayService = new BirthdayService();
    try {
